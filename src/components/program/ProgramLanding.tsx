  ...
  const team = [
    {
      ...
      color: "bg-auriu/20",
      highlight: "64 de ani. 25+ ani experiență economie. 5+ ani coaching transformațional.",
    ...
    },
    {
      ...
      role: "Practician EFT & Matrix Reimprinting",
      image: "/corina-harjoaba.jpg",
      color: "bg-roz-pudrat/30",
      highlight: "Practician EFT & Matrix Reimprinting.",
